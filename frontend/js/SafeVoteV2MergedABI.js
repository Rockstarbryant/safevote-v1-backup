export const SafeVoteV2MergedABI = [
  {
    inputs: [],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: 'enum VotingSystem.PollType',
        name: 'pollType',
        type: 'uint8',
      },
      {
    ...
    outputs: [
      {
        components: [
          ...
          {
            internalType: 'enum VotingSystem.PollStatus',
            name: 'status',
            type: 'uint8',
          },
        ],
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: 'struct SafeVoteV2.Position[]',
        name: 'positions',
        type: 'tuple[]',
      },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          {
            internalType: 'enum SafeVoteV2.ElectionStatus',
            name: 'status',
            type: 'uint8',
          },
          {
        ...
        internalType: 'struct SafeVoteV2.ElectionInfo',
        name: '',
        type: 'tuple',
      },
    ],
